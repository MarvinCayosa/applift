        ...
        {cards.map((card, idx) => (
          ...
          >
            ...
            >
              ...
              <div className="rounded-2xl overflow-hidden relative w-full mx-auto" style={{ height: 'clamp(170px, 22vh, 220px)' }}>
                {/* Background image */}
                <img
                  src={image}
                  alt={workout}
                  ...
                  <div className="space-y-2">
                    ...
                    {card.type === 'recommended' && (
                      <div className="flex items-center justify-between px-1">
                        <div className="flex gap-3">
                          ...
                          <div className="flex items-center gap-1.5">
                            <div className="w-6 h-6 flex items-center justify-center">
                              <img src="/images/icons/burn.png" alt="Burn" className="w-3.5 h-3.5" />
                            </div>
                            <div>
                    ...
                    {card.type === 'custom' && (
                      <div className="flex items-center justify-center gap-2 px-2">
                        ...
                        <p className="text-[11px] text-white/70">Enter your custom set</p>
                      </div>
                    )}
                  </div>
                </div>
