    ...
    <>
      ...
      <div className="min-h-screen bg-black text-white pb-28" style={{ paddingTop: 'env(safe-area-inset-top, 0px)' }}>
        ...
        <div className="px-4 space-y-6 relative z-10" style={{ marginTop: '-120px' }}>
          ...
          {setData.length > 0 && (
            <section className="content-fade-up-3">
              <h2 className="text-lg font-bold text-white mb-3">Set Breakdown</h2>
              <div className="space-y-2">
                {setData.map((set, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="bg-white/[0.05] rounded-2xl p-4 flex items-center justify-between"
                    >
                      <div className="flex items-center gap-3">
                        <div
                      ...
                      {set.classification && (
                        <span className="text-[10px] font-medium px-2.5 py-1 rounded-full bg-white/10 text-white/70">
                          {set.classification}
                        </span>
                      )}
                    </div>
